...
class VGG16(nn.Module):
        ...
        r"""
            Return the torch modules, containing VGG16 model.
            Args:
                in_channels : the number of channels included in input data.
                num_classes : the number of classes.
        """
            ...
            self.ConvBlock_2 = nn.Sequential(
                    collections.OrderedDict([
                        ...
                        ("Conv2d_23", nn.Conv2d(
                            ...
                            stride = (1,1),
                            padding = 1)),
                        ("Activation_23", nn.LeakyReLU()),
                        ("BatchNormal_23", nn.BatchNorm2d(256)),
                        ("Pooling2d_2", nn.MaxPool2d(kernel_size = (2,2), stride = (2,2)))
                        ]))
            ...
            self.ConvBlock_3 = nn.Sequential(
                    collections.OrderedDict([
                        ...
                        ("Conv2d_33", nn.Conv2d(
                            ...
                            stride = (1,1),
                            padding = 1)),
                        ("Activation_33", nn.LeakyReLU()),
                        ("BatchNormal_33", nn.BatchNorm2d(512)),
                        ("Pooling2d_3", nn.MaxPool2d(kernel_size = (2,2), stride = (2,2)))
                        ]))
            ...
            self.ConvBlock_4 = nn.Sequential(
                    collections.OrderedDict([
                        ...
                        ("Conv2d_43", nn.Conv2d(
                            ...
                            stride = (1,1),
                            padding = 1)),
                        ("Activation_43", nn.LeakyReLU()),
                        ("BatchNormal_43", nn.BatchNorm2d(512)),
                        ("Pooling2d_4", nn.MaxPool2d(kernel_size = (2,2), stride = (2,2)))
                        ]))
